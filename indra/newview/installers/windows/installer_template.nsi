...
Icon          %%SOURCE%%\installers\windows\install_icon_Zero-One.ico
UninstallIcon %%SOURCE%%\installers\windows\install_icon_Zero-One.ico
...
InstallDirRegKey HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\${INSTNAME}" ""
...
Function CheckIfAlreadyCurrent
  Push $0
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "Version"
...
;RMDir /r "$WINDIR\Application Data\Zero-One\cache"
;
;FunctionEnd
...
Push $2
  ...
  LOOP:
    ...
    StrCmp $INSTFLAGS "" RM_ALL RM_CACHE
      RM_ALL:
        RMDir /r "$2\Application Data\Zero-One"
      RM_CACHE:
        # Local Settings directory is the cache, there is no "cache" subdir
        RMDir /r "$2\Local Settings\Application Data\Zero-One"
        # Vista version of the same
        RMDir /r "$2\AppData\Local\Zero-One"
        Delete "$2\Application Data\Zero-One\user_settings\settings_windlight.xml"
...
; If the user is running on a pre-NT system, Application Data lives here instead of
; in Documents and Settings.
RMDir /r "$WINDIR\Application Data\Zero-One"
...
DetailPrint "Removing Zero-One password"

SetShellVarContext current
Delete "$APPDATA\Zero-One\user_settings\password.dat"
...
DeleteRegKey HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG"
...
lbl_check_silent:
	...
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\${INSTNAME}" "InstallerLanguage"
...
lbl_build_menu:
	...
	WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\${INSTNAME}" "InstallerLanguage" $LANGUAGE
lbl_return:
    Pop $0
    Return
FunctionEnd
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Write registry
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "" "$INSTDIR"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "Version" "${VERSION_LONG}"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "Flags" "$INSTFLAGS"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "Shortcut" "$INSTSHORTCUT"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Zero-One.\$INSTPROG" "Exe" "$INSTEXE"
